...
// piquage
if (empty($_POST["piquage"])) {
    $errorMSG .= "piquage manquant!";
} else {
    $piquage = $_POST["piquage"];
}


// modenature
if (empty($_POST["modenature"])) {
    $errorMSG .= "modenature manquant!";
} else {
    $modenature = $_POST["modenature"];
}


// nombre
if (empty($_POST["nombre"])) {
    $errorMSG .= "nombre manquant!";
} else {
    $nombre = $_POST["nombre"];
}
